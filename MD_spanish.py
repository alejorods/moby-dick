# Guía 3 - Ejercicio 6 (ESPAÑOL).
print("Guía 3 - Ejercicio 6 (ESPAÑOL).")

import numpy as np

file_es = open('Moby_Dick_ES.txt', 'r')

md_es = file_es.read()

total = len(md_es) 
print("Moby Dick en español tiene", total, "caracteres.")
...
for i in md_es:                                #Lista cuántas veces aparece cada caracter en Moby Dick en español.
    if i in dict_1:
        dict_1[i] = dict_1[i] + 1
    else:
        dict_1[i] = 1
...
for i in dict_1:                               #Lista la probabilidad por caracter en Moby Dick en español.
...
print()
print("La entropía por caracter de Moby Dick en español, medida en bits es:")
print(s_1)
...
for i in range(0,len(md_es)):                  #Lista cuántas veces aparece cada bigrama en Moby Dick en español.
    bigram = md_es[i:i+2]
    if bigram in dict_2:
...
for i in dict_2:                               #Lista la probabilidad por bigrama en Moby Dick en español.
...
for i in dict_2:                               
    ...
    s_2 = s_2 + entropy_2
s_2 = s_2 - s_1                                #Calcula la entropía por caracter usando bigramas.

print()
print("La entropía por caracter de Moby Dick en español para bigramas, medida en bits es:")
print(s_2)
...
for i in range(0,len(md_es)):                  #Lista cuántas veces aparece cada trigrama en Moby Dick en español.
    trigram = md_es[i:i+3]
...
for i in dict_3:                               #Lista la probabilidad por trigrama en Moby Dick en español.
...
print()                     
print("La entropía por caracter de Moby Dick en español para trigramas, medida en bits es:")
print(s_3)
